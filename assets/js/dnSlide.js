  ...
  if (typeof define === 'function' && define.amd) {
    ...
    $[_PLUGIN_].prototype = {
        ...
        settingDOM : function (){
            ...
            this.resourceIdArr = this.container.find('img').map(function(i,e){return e.id;});
            var ulDOM = this.container.html('<ul class="dnSlide-list"></ul>').find('.dnSlide-list');

            jQuery.each(this.resourceSrcArr , function(i,e){
                ulDOM.append('<li class="dnSlide-item"><a href="javascript:void(0)"><img class="slide-img" id="'+_this_.resourceIdArr[i]+'" src="'+_this_.resourceSrcArr[i]+'"  width="100%" ></a></li>');
            });
